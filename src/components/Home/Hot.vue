                    ...
                    <div style="padding: 14px;text-align: left">
                      ...
                      <div class="bottom clearfix">
                        <a style="font-size: 25px;color: orangered"><span
                          style="font-size: 15px">￥</span>{{ dq.goodsPrice }}</a><span
                        style="color: #99a9bf">{{ dq.goodsSales }}人已购买</span>
                      </div>
                    </div>
                  </el-card>
                </div>
                ...
                <div @click="selectGoodById(bg.id)">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <div style="padding: 14px;">
                      ...
                      <div class="bottom clearfix">
                        <a style="font-size: 25px;color: orangered"><span
                          style="font-size: 15px">￥</span>{{ bg.goodsPrice }}</a><span
                        style="color: #99a9bf">{{ bg.goodsSales }}人已购买</span>
                      </div>
                    </div>
                  </el-card>
                </div>
                ...
                <div @click="selectGoodById(mz.id)">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <div style="padding: 14px;" class="dspan">
                      ...
                      <div class="bottom clearfix">
                        <a style="font-size: 25px;color: orangered"><span
                          style="font-size: 15px">￥</span>{{ mz.goodsPrice }}</a><span
                        style="color: #99a9bf">{{ mz.goodsSales }}人已购买</span>
                      </div>
                    </div>
                  </el-card>
                </div>
                ...
                <div @click="selectGoodById(sp.id)">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <div style="padding: 14px;">
                      ...
                      <div class="bottom clearfix">
                        <a style="font-size: 25px;color: orangered"><span
                          style="font-size: 15px">￥</span>{{ sp.goodsPrice }}</a><span
                        style="color: #99a9bf">{{ sp.goodsSales }}人已购买</span>
                      </div>
                    </div>
                  </el-card>
                </div>
      ...
      <div style="margin-top: 20px">
        ...
        <div style="width: 500px;height: 500px;margin-left: 750px">
          ...
          <div v-if="warehouse.goodsAmount>0">
            <label>数量：
              <el-input-number v-model="num" @change="handleChange" :min="1" :max=warehouse.goodsAmount
          ...
          <div v-if="warehouse.goodsAmount<1">
            <label>数量：
              <el-input-number v-model="num" @change="handleChange" :min="0" :max="1" label="描述文字"></el-input-number>
            </label>
