<template>
  <div>
    ...
    <el-dialog width="62%" title="入库申请" :visible.sync="dialogTableVisible" center>
      <el-divider
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="refer">提交</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    refer() {
      ...
      params.append("registerStats", "1");
      this.$axios.post("stock/updateStockById", params).then(function (result) {
        _this.$message({
          showClose: true,
          message: '提交成功',
          type: 'success'
