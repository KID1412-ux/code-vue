      ...
      <el-col :span="5" style="margin-top: 3%">
        <el-card class="box-card" style="width: 100%">
          <div>
            ...
            <br>
            <el-link  :underline="false" ><h3>{{ userNickname }}</h3></el-link><br>
            <el-button size="mini" round>编辑个人资料</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="10" style="margin-top: 3%">
        <el-card shadow="never" style="height: 200px;margin-top: 16%">
          <div style="margin-top: 5%;margin-left: -10%">
            <label>默认提货商户：</label>
            <el-select placeholder="请选择自提店" v-model="merchant.merchantId" @change="changeAddress">
              <el-option label="--请选择--" :value="0"></el-option>
              <el-option v-for="(item, index) in merchants" :label="item.merchantName" :value="item.id"></el-option>
            </el-select>
            <el-popover
              placement="left"
              width="400"
          ...
          <div style="margin-top: 5%;margin-left: -10%">
            <el-row>
              ...
              <el-button type="primary" plain >申请成为商户</el-button>
              <el-button type="primary" plain>申请成为供应商</el-button>
            </el-row>
          </div>
        </el-card>
      </el-col>
